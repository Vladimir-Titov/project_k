...
Revision ID: 0001
Revises:
Create Date: 2026-07-27 18:45:01.729542
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f('ix_frontiers_characteristics_actions_characteristic_id'),
        table_name='characteristics_actions',
        schema='frontiers',
    )
    op.drop_index(
        op.f('ix_frontiers_characteristics_actions_action_id'), table_name='characteristics_actions', schema='frontiers'
    )
    op.drop_table('characteristics_actions', schema='frontiers')
